...
<!--                </el-form-item>-->
                ...
                <el-form-item>
                 ...
                 <el-form-item class="btnRight">
                    <el-button type="success" size ="small" icon="el-icon-plus" @click='onAddCustomer()'>添加客户</el-button>
                </el-form-item>
            </el-form>
        </div>
...
<!--                        >编辑</el-button>-->
                        <el-button
                            ...
                            icon='delete'
                            size="mini"
                            @click='onDeleteCustomer(scope.row)'
                        >删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
